...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(10.5, 0, 1);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(10.5, 0, 1);

    public static double LATERAL_MULTIPLIER = 1.04151199;
    ...
    public void interruptTrajectorySequence() {
        trajectorySequenceRunner.interruptTrajectorySequence();
    }
